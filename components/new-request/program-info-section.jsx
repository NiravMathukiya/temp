...
export default function ProgramInfoSection({ formProps }) {
  const {
    register,
    errors,
    setValue,
      ...
      <div className="bg-white p-4 md:p-6 rounded shadow grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="flex w-full">
            <select className="p-2 border border-gray-300 rounded-l bg-white w-28 sm:w-32" {...register("phonePrefix")}>
        ...
        <div className="sm:col-span-2 ">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="md:grid grid-cols-2 gap-2 mt-2">
              ...
              <div className="mt-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center">
                    <input type="checkbox" id="noAttendeesNumber" className="mr-1" {...register("noAttendeesNumber")} />
            ...
            {/* Flyer Upload */}
            <div className="mt-4">
              <label className="block text-sm font-medium text-gray-700">Provide flyer (1080x1080 if applicable)</label>
